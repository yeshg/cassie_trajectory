...
class CassieTrajectory:
    def __init__(self, filepath):
        ...
        foot_pos = np.load(os.path.join(dirname, "helei_reference_foot_data/ref_foot_pos.npy"))
        foot_vel = np.load(os.path.join(dirname, "helei_reference_foot_data/ref_foot_vel.npy"))
